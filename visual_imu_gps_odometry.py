...
class Visual_IMU_GPS_Odometry(object):
    ...
    def processFirstFrame(self):
        ...
        self.accel_ref = self.accel_cur
        self.vel_ref = 0.0
        self.pos_ref = 0.0
        self.gyro_ref = self.gyro_cur
        self.gps_ref = self.gps_cur
        self.timestamp_ref = self.timestamp_cur
    ...
    def processFrame(self, frame_id):
        ...
        time_delta = (self.timestamp_cur - self.timestamp_ref)
        if time_delta>0:
            vel = (self.accel_cur - self.accel_ref) / time_delta
            pos = (vel - self.vel_ref) / time_delta
            t = (t+pos)/2.0
    ...
    def track(self, img, frame_id,
        ...
        self.accel_cur = accel_data
        self.gyro_cur = gyro_data
        self.gps_cur = gps_data
        self.timestamp_cur = timestamp
        if kVerbose:
            # print('..................................')
